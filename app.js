...
const CURATED_GALLERY = {
  ...
  "boxer": ["Boxer female brown.jpg", "Brindle Male Boxer.jpg", "White Boxer (dog) 1.jpg"],
  "doberman-pinscher": ["Doberman Pinscher red standing.jpg", "Doberman Pinscher blue portrait.jpg"],
  "basenji": ["Basenji.jpg", "Basenji-b&w.jpg", "Basenji-red&white3.jpg"],
  "miniature-schnauzer": ["Schnauzer mini.jpg", "Miniature Schnauzer.jpg", "Schnauzer miniatura negro.JPEG"],
  "dachshund": ["Smooth Dachshund red and tan portrait.jpg", "Red-merle smooth Dachshund.jpg"],
  "german-shepherd-dog": ["German shepherd enjoying the sun.jpg", "German Shepherd Dog head Lamia 2005.jpg", "Adult male German shepherd dog standing at the beach (retouched).jpg"],
  "labrador-retriever": ["Female Black Labrador Retriever.jpg", "Labrador Retriever Chocolate Brown Portrait - Sam.jpg", "Labrador-retriever.jpg"],
...
async function loadCommonsGallery(breed) {
  ...
  const curated = CURATED_GALLERY[breed.id] || [];
...
async function loadVariationGallery(breed) {
  ...
  const jobs = variations.slice(0, 4).map(async query => {
    ...
    try {
      ...
      media.innerHTML = `<div class="photo-placeholder">Photo unavailable</div>`;
    }
  });
