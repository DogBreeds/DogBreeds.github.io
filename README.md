...
Header spacing refined; curated adult starter photos added for several breeds; Commons gallery loading now falls back to JSONP; variation cards no longer disappear when an image search fails.
